...
The desired end state is: package scaffolding is complete, and the only expected remaining work is implementing the TODO skill logic in `src/skill.ts`.
...
20. Do not run or require full extension build validation until source files are generated.
